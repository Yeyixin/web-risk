...
<head>
    ...
    <link rel="stylesheet" href="common/assets/css/fonts/linecons/css/linecons.css">
    <link rel="stylesheet" href="common/assets/css/fonts/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="common/assets/css/bootstrap.css">
    <link rel="stylesheet" href="common/assets/css/xenon-core.css">
    <link rel="stylesheet" href="common/assets/css/xenon-forms.css">
    <link rel="stylesheet" href="common/assets/css/xenon-components.css">
    <link rel="stylesheet" href="common/assets/css/xenon-skins.css">
    <link rel="stylesheet" href="common/assets/css/custom.css">

    <script src="common/assets/js/jquery-1.11.1.min.js"></script>
                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="common/assets/images/user-2.png" class="img-responsive img-circle" />
                        </a>
                    </div>
            ...
            <header class="logo-env">
                ...
                <div class="logo">
                    <a href="dashboard-1.html" class="logo-expanded">
                        <img src="common/assets/images/logo@2x.png" width="80" alt="" />
                    </a>

                    <a href="dashboard-1.html" class="logo-collapsed">
                        <img src="common/assets/images/logo-collapsed@2x.png" width="40" alt="" />
                    </a>
                </div>
        ...
        <nav class="navbar user-info-navbar" role="navigation">
            ...
            <ul class="user-info-menu right-links list-inline list-unstyled">
                ...
                <li class="dropdown user-profile">
                    <a href="#" data-toggle="dropdown">
                        <img src="common/assets/images/user-4.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
							<span>
								Arlind Nushi
        ...
        <footer class="main-footer sticky footer-type-1">
            ...
            <div class="footer-inner">
                ...
                <div class="footer-text">
                    &copy; 2014
                    <strong>Xenon</strong>
                    More Templates <a href="#" title="源码之家">源码之家</a> - Collect from <a href="#/" title="网页模板" target="_blank">网页模板</a>
                </div>
...
<script src="common/assets/js/TweenMax.min.js"></script>
<script src="common/assets/js/resizeable.js"></script>
<script src="common/assets/js/joinable.js"></script>
<script src="common/assets/js/xenon-api.js"></script>
<script src="common/assets/js/xenon-toggles.js"></script>


<!-- JavaScripts initializations and stuff -->
<script src="common/assets/js/xenon-custom.js"></script>
